...
source_path = 'zhihu_reply_out.csv'

source_sentences, target_sentences = helper.load_data(source_path)
#print(source_sentences[:50])
#print(target_sentences[:50])
...
i = 0
x = 0
checkpoint = '/Users/kumakaisen/PycharmProjects/untitled/best_model.ckpt'
            ...
            if batch_i % display_step == 0 and batch_i > 0:
                ...
                print('Epoch {:>3}/{} Batch {:>4}/{} - Loss: {:>6.3f}  - Validation loss: {:>6.3f}'
                      .format(epoch_i,
                              ...
                              loss,
                              validation_loss[0]))
                L.append(validation_loss[0])
                if i >= 9:
                    L1 = L[i - 9:i]
                    L2 = L1
                    L1.sort()
                    if L2 == L1 and L2[0] <= L2[1]:
                        x = 1
                        break
        if x==1:
            break
